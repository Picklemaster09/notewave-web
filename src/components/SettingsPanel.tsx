...
export default function SettingsPanel({
  ...
  return (
    <div id="settings-card-container" className="grid grid-cols-1 md:grid-cols-12 gap-6 p-4 md:p-6 rounded-3xl bg-white card-theme border border-[#E5E5EA] shadow-xl font-sans text-[#1C1C1E] text-primary-theme">
      ...
      <div className="md:col-span-4 flex flex-col gap-5 border-r border-[#F2F2F7] pr-2 md:pr-4">
        <div>
          <h2 id="settings-headline" className="text-xl font-black tracking-tight text-[#1C1C1E]">{langDict.tabSettings}</h2>
          <p className="text-[11px] text-gray-500 mt-1 font-semibold leading-relaxed">{langDict.settingsSubtitle}</p>
        </div>
        ...
        <nav className="flex flex-row md:flex-col gap-1.5 overflow-x-auto md:overflow-visible pb-3 md:pb-0 scrollbar-none">
          ...
          >
            ...
            <span>{langDict.tabAppearance}</span>
          </button>
          ...
          >
            ...
            <span>{langDict.tabAiSettings}</span>
          </button>
          ...
          >
            ...
            <span>{langDict.tabDataStorage}</span>
          </button>
        </nav>
      </div>
      ...
      <div className="md:col-span-8 flex flex-col gap-6 font-sans">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className="w-full bg-[#f9f9f9] input-theme border border-[#d1d1d6] rounded-xl px-3 py-2 text-xs font-semibold focus:outline-none focus:bg-[var(--bg-card)] focus:border-blue-500 transition-all text-gray-800 text-primary-theme"
                />
              </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className={`w-full border rounded-xl px-3 py-2 text-xs font-semibold focus:outline-none transition-all ${
                    isGoogleLogin
                      ? "bg-[#F2F2F7] input-theme border-[#E5E5EA] text-gray-400 cursor-not-allowed select-none"
                      : "bg-[#f9f9f9] input-theme border-[#d1d1d6] text-gray-800 text-primary-theme focus:bg-[var(--bg-card)] focus:border-blue-500"
                  }`}
                />
              </div>
            </div>
        ...
        {subTab === "appearance" && (
          <div id="settings-psection-appearance" className="flex flex-col gap-5">
            {/* Theme switcher */}
            <div className="flex flex-col gap-2.5">
              <label className="text-[10px] font-extrabold text-gray-400 uppercase tracking-widest">{langDict.themeLabel}</label>
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                >
                  ...
                  <span className="text-xs font-black">{langDict.themeDark}</span>
                </button>
                ...
                >
                  ...
                  <span className="text-xs font-black">{langDict.themeLight}</span>
                </button>
                ...
                >
                  <span className="text-xl">⚙️</span>
                  <span className="text-xs font-black">{langDict.themeSystem}</span>
                </button>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3 border-t border-[#F2F2F7] pt-4">
              <label className="text-[10px] font-extrabold text-gray-400 uppercase tracking-widest">{langDict.accentColorLabel}</label>
            ...
            <div className="flex flex-col gap-4 border-t border-[#F2F2F7] pt-4 font-sans">
              ...
              <select
                ...
                className="w-full bg-[#F9F9F9] input-theme font-sans text-xs text-gray-800 text-primary-theme px-3.5 py-2.5 rounded-xl border border-[#D1D1D6] focus:bg-[var(--bg-card)] focus:outline-none focus:border-blue-500 transition-all font-semibold cursor-pointer"
              >
              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-center justify-between">
                  <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest block select-none">
                    {settings.language === "es" ? "Consumo de Solicitudes de IA" : "Daily AI Request Balance"}
                  </label>
                  {isLoadingUsage && (
                ...
                <div className="bg-[#fdfdfd] border border-[#E5E5EA] rounded-2xl p-4 flex flex-col gap-3.5">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <span className="text-[9px] text-gray-400 font-bold block">
                        {settings.language === "es" ? "solicitudes hoy" : "requests today"}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="p-3 bg-slate-50 border border-dashed border-[#E5E5EA] rounded-xl text-[10.5px] text-gray-650 leading-relaxed font-semibold">
                    📖 <strong>Unified AI Quota Policy:</strong> {settings.language === "es" 
                      ? "Cada operación con inteligencia artificial equivale exactamente a 1 solicitud de tu saldo diario disponible. Esto incluye grabar un dictado de voz, importar un extracto/registro de texto o enviar un mensaje al Agente de IA en la pestaña de Mesa de Trabajo."
                      : "Every artificial intelligence transaction consumes exactly 1 unit of your daily prompt allowance. This encompasses recording one live voice dictation, uploading/indexing one text log document, or posting a query prompt to the Workspace AI Agent."}
                  </div>
                  ...
                  <div className="flex items-center justify-between text-[9px] text-gray-400 font-bold font-sans">
                    ...
                    <span>{usage ? `Remains: ${usage.remaining} Requests` : "Calculating..."}</span>
                  </div>
                </div>
              </div>
            </div>
